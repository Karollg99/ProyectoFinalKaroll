...
$file_name = str_replace(' ', '', $files['HojadeVida']['name']);
  $file_tmp = $files['HojadeVida']['tmp_name'];
 /* GUARDAMOS LA IMG TEMPORALMENTE */

move_uploaded_file($file_tmp, $_SERVER['DOCUMENT_ROOT'] . getFolderProject() . '/hojas/' . $file_name); /* INDICAMOS LA RUTA DONDE SE VA ALMACENAR ESA IMAGEN */
